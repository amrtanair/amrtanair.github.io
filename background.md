...
I joined [FOSS@Amrita](https://amfoss.in/), a club at Amrita University that promotes open source, in the freshman year of undergrad. Since then, I have actively participated in encouraging the club's primary cause. Additionally, I guide my juniors at the club to the best of my abilities, a tradition started by the founders of the club(back in 2007) and continued by the incoming batches of students.

<center><img src="assets/images/bundledore-Amrita-talk.jpeg" alt="amrita talk" width="400" height="400"> </center>

I started working on Ruby and Ruby on Rails in the first year of engineering and and at the end of second year, I was selected for the [Rails Girls Summer of Code](https://railsgirlssummerofcode.org/), a program which accepts 20 teams all over the world(2 students per team) each year and provides them with an open-source project to work on. It is a global fellowship program for women and non-binary coders.
...
A total of [25 hackers](https://2018.apricot.net/program/hackathon/) were chosen from the Asia-Pacific region. It was an honour to be selected to attend for this hackathon.
